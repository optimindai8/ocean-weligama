...
const roomSchema = z.object({
  ...
  type: z.enum(["room", "villa", "dormitory", "suite"]),
  maxGuests: z.coerce.number().min(1),
  bedrooms: z.coerce.number().min(0),
  bathrooms: z.coerce.number().min(0),
  basePricePerNight: z.string().min(1).regex(/^\d+(\.\d{1,2})?$/, "Invalid price format"),
              ...
              <div key={room.id} className="bg-card rounded-3xl border border-border/50 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden group">
                ...
                <div className="p-6 relative">
                  <div className="absolute -top-6 right-6">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="secondary" size="icon" className="w-12 h-12 rounded-full shadow-lg border-2 border-white hover:bg-gray-100">
                  ...
                  <div className="flex items-baseline gap-1 mb-6">
                    <span className="text-2xl font-black text-foreground">{room.basePricePerNight} {room.currency}</span>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <FormField control={form.control} name="slug" render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl><Input placeholder="basic-private-ground" {...field} className="rounded-xl" /></FormControl>
                          <FormMessage />
                        </FormItem>
                      )} />
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-muted/50 p-6 rounded-2xl space-y-4">
                      ...
                      <FormField control={form.control} name="highlights" render={() => <FormMessage />} />
                    </div>
                  </div>
