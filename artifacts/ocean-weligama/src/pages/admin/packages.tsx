...
export default function AdminPackages() {
  ...
  const onSubmit = (values: ServiceFormValues) => {
    const data = {
      ...
      category: values.type === "main" ? "Main Package" : values.category || "Beginner Surf Packages",
  ...
  return (
    <AdminLayout>
      <div className="p-8 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Manage Surf packages, Retreats, and Optional packages.
            </p>
          </div>
          <Button 
        ...
        ) : services && (services as Service[]).length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge variant={service.type === "main" ? "default" : "outline"} className="rounded-full">
                          ...
                          <FormItem>
                            ...
                            >
                              ...
                              <SelectContent className="rounded-xl">
                                <SelectItem value="main" className="rounded-lg">Surf Packages (Main)</SelectItem>
                                <SelectItem value="optional" className="rounded-lg">Optional Packages</SelectItem>
                              </SelectContent>
                            </Select>
                            <FormMessage />
                          </FormItem>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <Select onValueChange={field.onChange} value={field.value || ""}>
                                <FormControl>
                                  <SelectTrigger className="rounded-xl">
                                    <SelectValue placeholder="Select optional category" />
                                  </SelectTrigger>
                                </FormControl>
                                <SelectContent className="rounded-xl">
                                  <SelectItem value="Beginner Surf Packages" className="rounded-lg">Beginner Surf Packages</SelectItem>
                                  <SelectItem value="Advance Surf Packages" className="rounded-lg">Advance Surf Packages</SelectItem>
                                  <SelectItem value="Yoga Retreat Packages" className="rounded-lg">Yoga Retreat Packages</SelectItem>
                                </SelectContent>
                              </Select>
                              <FormMessage />
                            </FormItem>
