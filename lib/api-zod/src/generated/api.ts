...
export const ListServicesResponseItem = zod.object({
  ...
  comparisonLabel: zod.string().nullish(),
  ...
  extraLessonPrice: zod.string().optional(),
  extraSessionPrice: zod.string().optional(),
  unit: zod.enum(["per_person", "per_day", "per_session", "flat_rate"]),
...
export const AdminUpdateServiceBody = zod.object({
  ...
  extraSessionPrice: zod.string().optional(),
  unit: zod
    .enum(["per_person", "per_day", "per_session", "flat_rate"])
    .optional(),
  isActive: zod.boolean().optional(),
  isBookable: zod.boolean().optional(),
  name: zod.string().optional(),
